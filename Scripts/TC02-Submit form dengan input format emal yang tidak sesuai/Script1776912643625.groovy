...
def firstname = testData.getObjectValue('firstname', 2)
def lastname = testData.getObjectValue('lastname', 2)
def email = testData.getObjectValue('email', 2)
def mobile = testData.getObjectValue('mobile', 2)
