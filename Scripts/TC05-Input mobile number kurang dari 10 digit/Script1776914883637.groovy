...
def firstname = testData.getObjectValue('firstname', 5)
def lastname = testData.getObjectValue('lastname', 5)
def email = testData.getObjectValue('email', 5)
def mobile = testData.getObjectValue('mobile', 5)
