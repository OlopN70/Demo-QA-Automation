...
def firstname = testData.getObjectValue('firstname', 7)
def lastname = testData.getObjectValue('lastname', 7)
def email = testData.getObjectValue('email', 7)
def mobile = testData.getObjectValue('mobile', 7)
