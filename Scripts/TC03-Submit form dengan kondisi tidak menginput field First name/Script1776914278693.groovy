...
def firstname = testData.getObjectValue('firstname', 3)
def lastname = testData.getObjectValue('lastname', 3)
def email = testData.getObjectValue('email', 3)
def mobile = testData.getObjectValue('mobile', 3)
...
// ================= ASSERTION =================
WebUI.verifyElementVisible(findTestObject('Object Repository/TCNegative/input_Name_firstName'))

WebUI.scrollToElement(findTestObject('Object Repository/TCNegative/input_Name_firstName'), 0)
