...
def firstname = testData.getObjectValue('firstname', 4)
def lastname = testData.getObjectValue('lastname', 4)
def email = testData.getObjectValue('email', 4)
def mobile = testData.getObjectValue('mobile', 4)
...
// ================= ASSERTION =================
WebUI.scrollToElement(findTestObject('Object Repository/TCNegative/input_Name_lastName'), 0)
