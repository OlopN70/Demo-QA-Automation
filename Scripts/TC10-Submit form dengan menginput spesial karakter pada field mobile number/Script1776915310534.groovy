...
def firstname = testData.getObjectValue('firstname', 8)
def lastname = testData.getObjectValue('lastname', 8)
def email = testData.getObjectValue('email', 8)
def mobile = testData.getObjectValue('mobile', 8)
